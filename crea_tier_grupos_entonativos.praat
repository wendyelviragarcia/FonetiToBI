# Creado por Juanma el 16.01.2008
# Script para crear un tier con la segmentacion en grupos entonativos de un TextGrid de entrada que contenga tres tier:
# - segmentacion en silabas que incluya las pausas
# - transcripcion fonetica
# - transcripcion ortografica en palabras
...
if etiqueta_sonido$ = "..." or etiqueta_sonido$ = "_"
